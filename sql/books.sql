...
--
-- Host: 127.0.0.1
-- Czas generowania: 18 Gru 2019, 19:27
...
CREATE TABLE `customers` (
  ...
  `cu_creatorTS` date NOT NULL,
  `cu_modTS` date NOT NULL,
  `cu_modID` int(11) NOT NULL,
  `cu_isArchival` tinyint(1) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
('507180bb-8bcf-450b-b95c-68370073ef86', 1576704379, '{\"cookie\":{\"originalMaxAge\":null,\"expires\":null,\"httpOnly\":true,\"path\":\"/\"}}');
