...
--
-- Host: 127.0.0.1
-- Czas generowania: 05 Sty 2020, 13:40
...
('76d0439b-1a94-4798-b34d-61735e33a6cf', 1578233436, '{\"cookie\":{\"originalMaxAge\":null,\"expires\":null,\"httpOnly\":true,\"path\":\"/\"}}');
...
--
ALTER TABLE `orders`
  MODIFY `or_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;

--
-- AUTO_INCREMENT dla tabeli `order_books`
--
ALTER TABLE `order_books`
  MODIFY `ob_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=47;
